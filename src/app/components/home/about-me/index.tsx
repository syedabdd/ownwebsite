          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  I’m a passionate Full Stack Developer with a strong foundation in the MERN stack, specializing in building scalable, high-performance web applications. I focus on creating modern, responsive, and user-friendly interfaces using React.js, Next.js, and Tailwind CSS. With hands-on experience in real-world projects, I write clean, maintainable code and continuously strive to improve performance, user experience, and overall product quality.
                </p>
                ...
                <div className="grid grid-cols-3 py-10 xl:py-16 gap-5 border-b border-mistGray">
                  {[
                    ...
                    { count: "5+", label: "Technologies Mastered" },
                  ].map((item, i) => (
                    <div key={i}>
                      <h3>{item.count}</h3>
