              ...
              {contactBarData?.contactItems?.map(
                (value: any, index: number) => (
                  <a
                    key={index}
                    href={value?.link}
                    className="flex items-center gap-2 lg:gap-4 text-sm md:text-base cursor-pointer"
                  >
                    <Image
                    ...
                    <h6 className="text-sm md:text-base xl:text-xl hover:text-primary transition">
                      {value?.label}
                    </h6>
                  </a>
                )
